...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-8 prose prose-blue max-w-none prose-headings:text-gray-900 prose-p:text-gray-600 prose-li:text-gray-600 prose-strong:text-gray-900">
        @if($aboutContent)
            {!! $aboutContent !!}
        @else
